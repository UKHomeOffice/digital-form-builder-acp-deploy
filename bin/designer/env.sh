...
'test')
    ...
    export KUBE_CERTIFICATE_AUTHORITY=https://raw.githubusercontent.com/UKHomeOffice/acp-ca/master/acp-notprod.crt
    export PREVIEW_URL: https://forms-runner.test.stp-forms-notprod.homeoffice.gov.uk
    export PUBLISH_URL: https://forms-runner.test.internal.stp-forms-notprod.homeoffice.gov.uk
        ;;
...
'preprod')
    ...
    export KUBE_CERTIFICATE_AUTHORITY=https://raw.githubusercontent.com/UKHomeOffice/acp-ca/master/acp-notprod.crt
    export PREVIEW_URL: https://forms-runner.preprod.stp-forms-notprod.homeoffice.gov.uk
    export PUBLISH_URL: https://forms-runner.preprod.internal.stp-forms-notprod.homeoffice.gov.uk
        ;;
    *)
